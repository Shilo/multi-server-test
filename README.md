...
- A shared build/version gate so mismatched clients and world servers are
  rejected before login, route loading, or world travel.
...
This is a compatibility gate, not real authentication. Public VirtuCade builds
still need authenticated sessions before account/resume security is production
ready.

...
Smoke/CI launches master and client scenes directly when testing from the editor binary. Exported full-world travel will be re-enabled after the PackRat addon is added and the client can download missing `server/worlds/` packs before joining worlds.
...
- PackRat is not wired into this project yet; the old custom world-pack downloader was removed.
